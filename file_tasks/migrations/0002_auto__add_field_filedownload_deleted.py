...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FileDownload.deleted'
        db.add_column('file_tasks_filedownload', 'deleted', self.gf('pr_services.fields.PRBooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FileDownload.deleted'
        db.delete_column('file_tasks_filedownload', 'deleted')
