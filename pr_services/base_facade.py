...
managers.add_import('MessageFormatManager', 'pr_services.messaging.message_format_manager')
managers.add_import('MessageTemplateManager', 'pr_services.messaging.message_template_manager')
managers.add_import('MessageTypeManager', 'pr_services.messaging.message_type_manager')
...
models.add_import('MessageFormat', 'pr_messaging.models')
models.add_import('MessageTemplate', 'pr_messaging.models')
models.add_import('MessageType', 'pr_messaging.models')
